...
abstract class ADataArray extends DataNode implements Iterable<DataNode> {
	...
	Iterator<DataNode> iter = iterable.iterator();
    ...
    private static class NodeIterator implements Iterator<DataNode> {
