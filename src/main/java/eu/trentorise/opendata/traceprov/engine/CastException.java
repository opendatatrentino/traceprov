...
public class CastException extends Exception {
    ...
    private static String makeMessage(Object value, TraceType type, Locale locale, String reason){
    ...
    public CastException(Object value, TraceType type, Locale locale, String reason) {
        super(makeMessage(value, type, locale, reason));
    }

    public CastException(Object value, TraceType type, Locale locale, String reason, Exception ex) {
