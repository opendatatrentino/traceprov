...
public final class TraceRefs {
	...
	retb.setTracePath(dataNodesPath(nodeIds));

	return retb.build();

    }

    private static String dataNodesPath(Iterable<Long> nodeIds) {
     ...
     *             if path does not correspond to actual fields in the java
     *             classes.
     */
